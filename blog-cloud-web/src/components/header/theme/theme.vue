...
<template>
  <div
    class="actionTheme actionTheme-root theme_click"
    :class="'actionTheme-' + themeStore.getTheme"
  >
    <div class="actionTheme-tabs__block theme_click"></div>
    <div
      @click="selectTheme(ThemeEnum.LIGHT)"
      data-theme="light"
      class="sun action_item theme_click"
    >
      <svg
        width="20"
        height="20"
    ...
    <div
      @click="selectTheme(ThemeEnum.DARK)"
      data-theme="dark"
