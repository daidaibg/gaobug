...
export default class signMd5Utils {
     ...
     * @returns {string} 获取签名
     */
    static getSign(params:any,timestamp:number) {
        let requestBody = this.sortAsc(params);
        // console.log(JSON.stringify(requestBody)+timestamp);
        return md5(JSON.stringify(requestBody)+timestamp);
    }
