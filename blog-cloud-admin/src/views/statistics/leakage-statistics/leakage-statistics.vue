<template>
	<div class="contents">
		...
		<div class="flex flex-direction bg-white box-shadow-item rdx-p-tb-20 rdx-p-l-20 rdx-p-r-10 rdx-m-t-16">
			<span class="font-strong">漏电电流统计</span>
...
<!-- 				<el-table-column type="selection" align="center" width="55">
				...
				<el-table-column prop="createtime" label="漏电电流" align="center">
				</el-table-column>
				<el-table-column prop="alertname" label="相线" align="center">
				</el-table-column>
				<el-table-column prop="alertname" label="时间" align="center">
				</el-table-column>
			</yh-table-pag>
		</div>
	</div>
