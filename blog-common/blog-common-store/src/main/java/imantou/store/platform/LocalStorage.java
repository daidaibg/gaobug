package imantou.store.platform;

import imantou.store.FileStorage;
import imantou.store.autoconfigure.OssProperties;
import imantou.store.model.OssMark;
import imantou.store.model.OssMessage;
